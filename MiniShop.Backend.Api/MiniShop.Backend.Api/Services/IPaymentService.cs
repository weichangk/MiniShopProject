...
{
    public interface IPaymentService : IBaseService<Payment, PaymentDto, int>
    {
    ...
    public interface ICreatePaymentService : IBaseService<Payment, PaymentCreateDto, int>
    {

    }

    public interface IUpdatePaymentService : IBaseService<Payment, PaymentUpdateDto, int>
    {
